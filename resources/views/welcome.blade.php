                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Coalition
                                            Technologies (Laravel Test Skill
                                            for Remote Laravel Developer)
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="#"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Mickel Angelo Dizon</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    ResumeLink: https://madizon.jobs180.com/ <br>
                                    Email or Skype: mickel.angelo.dizon@gmail.com <br>
                                    Viber: +63 977 821 8020
                                </p>
                            </div>
                        </a>
                        ...
                        <a href="#"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Laravel Web application
                                </h2>
